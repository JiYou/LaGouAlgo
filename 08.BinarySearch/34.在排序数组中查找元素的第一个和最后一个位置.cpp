...
class Solution {
    ...
    RandomIterator _lower_bound(RandomIterator first, RandomIterator last, ValueType v) {
    ...
    template<typename RandomIterator, typename ValueType>
    RandomIterator _upper_bound(RandomIterator first, RandomIterator last, ValueType v) {
        if (first == last) return first;
        while (first != last) {
